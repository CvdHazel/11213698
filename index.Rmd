...
!audio[ why you gotta kick me when i'm down](https://open.spotify.com/track/2lLsjgDoS0Hg5pNNHymXGG?si=NvzCIyy7T3-kulE2cm0eLQ){ size=10 duration=10 cycle=forever }
...
By using the Bring Me The Horizon albums and the genre playlist, I hope to answer my research question 
...
grid.arrange(p1, p2, name = "heavy metal by BMTH", ncol = 2)
...
grid.arrange(p3, p4, name = "walk by Pantera", ncol = 2)
